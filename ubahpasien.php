  ...
  <!-- HEADER MOBILE-->
        ...
        <div class="page-container">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>UBAH DATA</strong> PASIEN
                                    </div>
                                    ...
                                    <div class="row form-group">
                                         ...
                                         <div class="col-12 col-md-9">
                                            <input type="hidden" name="ID_Pasien" id="ID_Pasien" required="" value="<?= $pasien["ID_Pasien"] ?>">
         ...
         <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" name="Nama_Pasien" id="Nama_Pasien" required="" placeholder="Masukan Nama" class="form-control" value="<?= $pasien["Nama_Pasien"] ?>">
             </div>
         </div>
        <div class="row form-group">
             <div class="col col-md-3" >    
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <textarea  name="Alamat" id="Alamat" required="" placeholder="Masukan Alamat" class="form-control" value="<?= $pasien["Alamat"] ?>"></textarea>
            </div>
        </div>
        <div class="row form-group">
            <div class="col col-md-3">
            ...
            <div class="col-12 col-md-9">
                <input type="date" name="tgl_lahir" id="tgl_lahir" required="" class="form-control" value="<?= $pasien["tgl_lahir"] ?>">
            </div>
        </div>
        <div class="row form-group">
            <div class="col col-md-3">
             ...
             <div class="col-12 col-md-9">
                <input type="number" name="Umur" id="Umur" required="" placeholder="Masukan Umur" class="form-control" value="<?= $pasien["Umur"] ?>">
            </div>
        </div>
        <div class="row form-group">
            <div class="col col-md-3">
            ...
            <div class="col-12 col-md-9">
                <input type="text" name="Penyakit" id="Penyakit" required="" placeholder="Masukan Penyakit" class="form-control" value="<?= $pasien["Penyakit"] ?>">
            </div>
        </div>
         <div class="row form-group">
            <div class="col col-md-3">
            ...
            <div class="col-12 col-md-9">
               <select name="ID_Dokter" id="ID_Dokter" class="form-control">>
                    <option value="<?= $pasien["ID_Dokter"] ?>">-pilih-</option>
                    <?php 
        ...
        <div class="row form-group">
            <div class="col col-md-3">
             ...
             <div class="col-12 col-md-9">
                <select name="ID_Kamar" id="ID_Kamar" required="" class="form-control">
                    <option value="<?= $pasien["ID_Kamar"] ?>">-pilih-</option>
                    <?php 
            ...
            <div class="col-12 col-md-9">
                ...
                <option value="<?= $pasien["ID_Obat"] ?>">-Pilih-</option>
                <?php 
