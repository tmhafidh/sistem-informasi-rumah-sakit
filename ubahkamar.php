...
$kamar = query ("SELECT * FROM kamar WHERE ID_Kamar = '$ID_Kamar'")[0];
 ...
 <!-- MENU SIDEBAR-->
    ...
    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="row form-group">
                ...
                <input type="hidden" name="ID_Kamar" id="ID_Kamar" required="" value="<?= $kamar["ID_Kamar"] ?>">
                </div>
            </div>
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" name="Nama_Kamar" id="Nama_Kamar" required=""placeholder="Masukan Nama Kamar & Nomor Kamar" class="form-control" value="<?= $kamar["Nama_Kamar"] ?>">
            </div>
        </div>
        <div class="row form-group">
            <div class="col col-md-3">
                <label for="Kelas_Kamar"  class=" form-control-label">Kelas Kamar </label>
             </div>
            <div class="col-12 col-md-9">
                <select name="Kelas_Kamar" id="Kelas_Kamar" class="form-control">
                    <option value="<?= $kamar["Kelas_Kamar"] ?>" >-Pilihan-</option>
        ...
        <div class="row form-group">
            <div class="col col-md-3">
                <label for="stok" class=" form-control-label">Stok Ranjang </label>
            </div>
            <div class="col-12 col-md-9">
                <input type="number" name="stok" id="stok" required="" placeholder="Masukan Stok Kamar" class="form-control" value="<?= $kamar["stok"] ?>">
            </div>
        </div>
