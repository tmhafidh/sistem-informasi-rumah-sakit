                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>UBAH DATA</strong> DOKTER
                                    </div>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="Nama_Dokter" id="Nama_Dokter" placeholder="Masukan Nama" class="form-control" required="" value="<?= $dokter["Nama_Dokter"] ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="Spesialis" id="Spesialis" placeholder="Masukan Spesialis" class="form-control" required="" value="<?= $dokter["Spesialis"] ?>">
                                                </div>
                                            </div>
