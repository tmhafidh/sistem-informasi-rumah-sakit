	...
	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		<div class="row form-group">
			<div class="col col-md-3">
				...
				<input type="hidden" name="ID_Kamar" id="ID_Kamar" required="" value="<?php echo $hasilkode ?>">
		...
		<div class="row form-group">
			...
			<div class="col-12 col-md-9">
				<input type="text" name="Nama_Kamar" id="Nama_Kamar" required=""placeholder="Masukan Nama Kamar & Nomor Kamar" class="form-control">
			</div>
		</div>
		<div class="row form-group">
			<div class="col col-md-3">
		...
		<div class="row form-group">
			...
			<div class="col-12 col-md-9">
				<input type="number" name="stok" id="stok" required="" placeholder="Masukan Stok Kamar" class="form-control">
		 	</div>
		</div>
