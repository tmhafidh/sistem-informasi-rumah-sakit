...
$kamar = query("SELECT * FROM tb_judul ORDER BY judul DESC");

// tombol cari ditekan
if (isset($_POST["cari"])) {
    $kamar = carikamar($_POST["keyword"]);
}
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <h1>DATA KAMAR R.S MALIKUSSALEH</h1>
                    <br>
                    <button class="au-btn au-btn-icon au-btn--blue">
                        <a href="tambahkamar.php" style="color: white;">Tambah Kamar</a>
                        <i class="zmdi zmdi-plus"></i></button>
                    <div class="row m-t-30">
                        <div class="col-md-12">
                            <!-- DATA TABLE-->
                            <div class="table-responsive m-b-40">
                                <table class="table table-bordered table-data3 datatab">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Judul</th>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Hapus">
                                                            <a href="hapuskamar.php?ID_Kamar=<?= $row["ID_Kamar"]; ?>" onclick="return confirm('Apakah anda menghapus ?');"><i class="zmdi zmdi-delete"></i></a>
                                                        </button>
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Ubah">

                                                            <a href="ubahkamar.php?ID_Kamar=<?= $row["ID_Kamar"]; ?>"><i class="zmdi zmdi-edit"></i></a>
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
