    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">        
                	<h1>DATA PASIEN R.S MALIKUSSALEH</h1>
                	<br>
    ...
    <tr>
        ...
        <td>
            ...
            <button class="item" data-toggle="tooltip" data-placement="top" title="Hapus">
                <a href="hapuspasien.php?ID_Pasien=<?= $row["ID_Pasien"];?>" onclick="return confirm('Apakah Sudah Sesuai ?');"><i class="zmdi zmdi-delete"></i></a><!-- </button>
