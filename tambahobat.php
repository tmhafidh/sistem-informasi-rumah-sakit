...
$carikode = mysqli_query($conn, "SELECT ID_Obat FROM obat ORDER BY ID_Obat DESC ") or die (mysqli_error($conn));
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>TAMBAH DATA</strong> OBAT
                                    </div>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="row form-group">
            <div class="col col-md-3">
                <label for="ID_Obat" class=" form-control-label">ID Obat </label>
                </div>
                <div class="col-12 col-md-9">
                <input type="hidden" name="ID_Obat" id="ID_Obat" required="" value="<?php echo $hasilkode ?>">
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" name="Nama_Obat" id="Nama_Obat" required=""placeholder="Masukan Nama Obat" class="form-control">
            </div>
        </div>
        <div class="row form-group">
            <div class="col col-md-3">
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="number" name="stok" id="stok" required="" placeholder="Masukan Stok Obat" class="form-control">
            </div>
        </div>
