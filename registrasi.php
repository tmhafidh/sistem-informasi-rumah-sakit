		...
		<form action="" method="post">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" name="password2" placeholder="konfirmasi Password" id="password2">
                                </div>
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" name="register">Daftar</button>
                            </form>
