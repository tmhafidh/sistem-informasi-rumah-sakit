    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">        
                	<h1>DATA DOKTER R.S MALIKUSSALEH</h1>
                	<br>
                	<button class="au-btn au-btn-icon au-btn--blue">
                						<a href="tambahdokter.php" style="color: white;">Tambah Dokter</a>
											...
											<tr>
												...
												<td>
													...
													<button class="item" data-toggle="tooltip" data-placement="top" title="Hapus">
                                                        <a href="hapusdokter.php?ID_Dokter=<?= $row["ID_Dokter"];?>" onclick="return confirm('Apakah ingin dihapus ?');"><i class="zmdi zmdi-delete"></i></a>
                                                    </button>
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Ubah">  
                                                        <a href="ubahdokter.php?ID_Dokter=<?= $row["ID_Dokter"];?>"><i class="zmdi zmdi-edit"></i></a>
                                                    </button>
                                                </div>
												</td>
											</tr>
